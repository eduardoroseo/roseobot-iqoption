...
class IQ_Option:
    ...
    def check_win_v4(self, id_number):
        while True:
            ...
            if result['msg']['closed_options'][0]['id'][0] == id_number and \
                    result['msg']['closed_options'][0]['id'][0] != None:
                return result['msg']['closed_options'][0]['win'], (
                    result['msg']['closed_options'][0]['win_amount'] - result['msg']['closed_options'][0][
                        'amount'] if result['msg']['closed_options'][0]['win'] != 'equal' else 0)
                break
            time.sleep(1)
